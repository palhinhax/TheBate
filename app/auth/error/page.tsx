...
const errorMessages: Record<string, { title: string; description: string }> = {
  Configuration: {
    ...
    description:
      "There is a problem with the server configuration. This is likely due to missing environment variables (AUTH_SECRET, GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, or DATABASE_URL).",
  },
  AccessDenied: {
    title: "Access Denied",
    description:
  ...
  OAuthSignin: {
    ...
    description:
      "Error signing in with OAuth provider. Please check that GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET are correctly configured.",
  },
  OAuthCallback: {
    title: "OAuth Callback Error",
    description:
      "Error processing OAuth callback. This might be due to incorrect redirect URIs in Google Cloud Console or database connection issues.",
  },
  OAuthCreateAccount: {
    title: "Error Creating Account",
    description:
      "Could not create account with OAuth provider. This is usually caused by database connection issues or missing database tables.",
  },
  EmailCreateAccount: {
  ...
  Callback: {
    ...
    description:
      "Error in the authentication callback. This might be due to database issues or missing OAuth configuration.",
  },
  CredentialsSignin: {
    title: "Sign In Failed",
    description:
      "The credentials you provided are incorrect. Please check your email and password.",
  },
  SessionRequired: {
