...
export default function LoginPage() {
  ...
  const handleMagicLinkSubmit = async (data: EmailFormData) => {
    setIsLoading(true);
    setError(null);
        ...
        <CardContent className="space-y-4">
          {emailSent ? (
            ...
            <>
              ...
              {/* Magic Link Form */}
              <form onSubmit={handleSubmitEmail(handleMagicLinkSubmit)} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="magic-email">{t("settings.email")}</Label>
                  <Input
                    id="magic-email"
                    type="email"
